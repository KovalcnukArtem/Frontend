...
// const fieldOne = "Привіт";
// const fieldTwo = "До побачення";
...
// const message = sum >= 10 ? "Сума більша за 10" : "Сума менша або дорівнює 10";
...
// const text = "Я вивчаю мову програмування JavaScript";
// const messageOne = text.includes("JavaScript")
...
// const password = "GoITeens";

// if ([title.length > 3] && email.includes("@") && [password.length] > 6) {
