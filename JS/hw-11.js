...
//     який дозволяє додавати гроші на рахунок, та метод "withdraw", який дозволяє знімати гроші з рахунку.
...
const user = {
  ...
  email: "artem.kovalchuk@example.com",
  ...
  login() {
    ...
    if (inputEmail === this.email && inputPassword === this.password) {
      alert("Вхід успішний! Ласкаво просимо, " + this.name + "!");
    } else {
