...
// 9. За допомогою об’єкту Math виведіть в консоль найбільше і найменше значення серед заданих (2, 34, 99, 3, 22, 36, 733, 18)
const maxValue = Math.max(2, 34, 99, 3, 22, 36, 733, 18);
const minValue = Math.min(2, 34, 99, 3, 22, 36, 733, 18);

console.log(maxValue);
console.log(minValue);

// 10. У змінну random згенеруйте випадкове число від 3 до 19 включно. Результат виведіть в консоль
// Math.random() * (max - min) + min;
const random = Math.random() * (19000 - 300) + 300;
