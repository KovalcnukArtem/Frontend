...
const result = calculateEngravingPrice("Best wishes for you", 10);
// console.log(result);
...
const formatString = function (string) {
  // 1. Зробити перевірку на довжину рядка, якщо менше 40 символів - повертати рядок; якщо більше 40 символів -
  // треба обрізати за допомогу slice(початок і кінець)
  if (string.length < 40) {
    return string;
  } else {
...
// //   console.log(numbers);
// // }
// // 2. Коли зупиниться дія циклу While необхідно порахувати суму всіх елементів масиву і
// // записати її в змінну total.Використовуй цикл for або for...of.
// if (numbers.length > 0) {
//   for (const number of numbers) {
//     total += number;
//   }
